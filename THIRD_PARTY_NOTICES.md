...
## Bundled vocabulary enrichment presets

- **ECDICT** — phonetic, part of speech, English definitions, Chinese
  translations and inflection exchange data for the bundled high-frequency
  word cards (`src/ielts_coach/resources/words/enrichments/
  yanxi-presets-high-freq.jsonl`). Source: https://github.com/skywind3000/ECDICT
  (MIT License, aggregation of open dictionary sources). The preset file is
  generated by `scripts/build_vocab_presets.py` and contains only entries for
  words already present in the project's own MIT/public-domain word lists.
