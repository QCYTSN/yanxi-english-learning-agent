...
- exam word lists join the pool: CET-4 (4536), CET-6 (3989), TOEFL (10357),
  the Academic Word List IELTS core (568) and an IELTS core list (1647, MIT
  source) — deduplicated pool of ~14 000 words, exam tags preserved per
  word; word forms only, sourced and attributed in THIRD_PARTY_NOTICES;
